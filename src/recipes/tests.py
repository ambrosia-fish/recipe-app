...
class RecipeSearchFormTest(TestCase):
    def test_recipe_title_field_label(self):
        ...
        self.assertTrue(
            form.fields["recipe_title"].label is None
            or form.fields["recipe_title"].label == "Recipe title"
        )
    ...
    def test_recipe_ingredients_cleaning(self):
        ...
        self.assertTrue(form.is_valid())
        self.assertEqual(
            form.cleaned_data["recipe_ingredients"], "salt,pepper,olive oil"
        )
...
class RecipeAnalyticsFormTest(TestCase):
    ...
    def test_valid_choices(self):
        form_data = {"analysis_type": "ingredients", "chart_type": "bar"}
        form = RecipeAnalyticsForm(data=form_data)
        self.assertTrue(form.is_valid())

    def test_invalid_choices(self):
        form_data = {"analysis_type": "invalid", "chart_type": "invalid"}
        form = RecipeAnalyticsForm(data=form_data)
        self.assertFalse(form.is_valid())
